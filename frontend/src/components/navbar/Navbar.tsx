...
export default function Navbar({
	...
	// 5. Combine them into one master array
	...
	return (
		<nav className="sticky top-0 z-50 border-b border-neutral-100 bg-white/80 shadow-sm backdrop-blur-md">
			<MaxWidthWrapper className="grid h-20 grid-cols-3 items-center md:grid md:grid-cols-[1fr_auto_1fr]">
				...
				<div className="order-3 justify-self-end items-center flex gap-3 md:hidden">
					<button className="">
							...
							<AnimatePresence>
								{activeDropdown === index && item.sections && (
									<motion.div
										...
										animate={{ opacity: 1, y: 0 }}
										exit={{ opacity: 0, y: 5 }}
										className="absolute top-full left-1/2 w-150 -translate-x-1/2 pt-4"
									>
