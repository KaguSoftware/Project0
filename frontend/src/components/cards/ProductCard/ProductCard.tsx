...
export default function ProductCard({ product }: ProductCardProps) {
    ...
    return (
        <div className="flex flex-col w-full max-w-xs mx-auto group cursor-pointer bg-white">
            <div className="relative w-full h-96 max-w-xs overflow-hidden group mx-auto cursor-pointer bg-white z-0">
            ...
            <div
                className="text-center flex flex-col gap-1 mt-3 px-2">
